...
public class wc {
	...
	public long wcount;
	public long lcount;
	public long total_ccount = 0;
	public long total_wcount = 0;
	public long total_lcount = 0;
	public String filename;
	public boolean skipped = false;


	public void counter(String string, String path) throws IOException {
		filename = string;

		try {
		FileReader fr = new FileReader(path + "/" + string);
